        ...
        <View>
          ...
          <View
            ...
            <View
              ...
              <TextInput value={fullname} onChangeText={(value) => setFullName(value)} editable />
            </View>
          </View>
          ...
          <View
            ...
            <View
              ...
              <TextInput value={address} onChangeText={(value) => setAddress(value)} editable />
            </View>
          </View>
          <View
            style={{
            ...
            <View
              ...
              <TextInput value={age} onChangeText={(value) => setAge(value)} editable />
            </View>
          </View>
