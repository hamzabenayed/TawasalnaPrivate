    ...
    <ScrollView showsVerticalScrollIndicator>
      <View style={{ backgroundColor: Colors.WHITE, marginBottom: 10 }}>
        <View
          ...
          <Text style={{ color: Colors.BLACK, fontSize: 27, fontWeight: 'bold' }}>
            Hamza Ben Ayed
          </Text>
          <Text style={{ color: Colors.BLACK, fontSize: 19 }}>2,1 K Friends</Text>
        </View>
        <View
          style={{
            flexDirection: 'row',
          ...
          <TouchableOpacity
            ...
            onPress={() => {}}>
            <Text style={{ fontSize: 19, color: Colors.WHITE, fontWeight: 'bold' }}>
              Add To Story
            </Text>
          </TouchableOpacity>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <FontAwesome5 name="caret-down" size={24} color="black" style={{ marginLeft: 2 }} />
          </TouchableOpacity>
      ...
      <View
        ...
        <Text style={{ marginLeft: -280, fontSize: 25, fontWeight: 'bold' }}>Intro</Text>
        <TouchableOpacity
          style={{
            backgroundColor: Colors.PURPLE,
            width: 280,
          ...
          <Text style={{ fontSize: 20, color: Colors.WHITE, fontWeight: 'bold' }}>Add a bio</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={{
            backgroundColor: Colors.PURPLE,
      ...
      <View
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Text style={{ fontSize: 18, fontWeight: 'bold', marginLeft: 10 }}>live video</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={{
              width: 160,
      ...
      <View
        ...
        <View style={{ alignItems: 'center', flexDirection: 'row', marginTop: 20 }}>
          <Text style={{ fontSize: 15, fontWeight: 'bold', marginLeft: 5 }}>Publications</Text>
          <TouchableOpacity
            style={{
              flexDirection: 'row',
              marginLeft: 30,
          ...
          <TouchableOpacity
            ...
            <Text style={{ fontWeight: 'bold', marginLeft: 2 }}>Manage publications</Text>
          </TouchableOpacity>
        </View>
        <View
          style={{
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Text style={{ fontSize: 15, fontWeight: 'bold', marginLeft: 5 }}>List View</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={{
              flexDirection: 'row',
            ...
            <Text style={{ fontWeight: 'bold', marginLeft: 5, fontSize: 15 }}>Grid View</Text>
          </TouchableOpacity>
        </View>
      </View>
      <FlatList
        ...
        renderItem={({ item }) => <ShowPosts ShowPostsitem={item} />}
      />
    </ScrollView>
  );
};
